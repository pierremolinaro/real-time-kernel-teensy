...
runProcess (["cp", "solutions/09-critical-section/sources/setup-loop.cpp", DOCUMENT_DIR + "/09-files"])
...
runProcess (["cp", "solutions/10-fault-handler--assertion/sources/time.cpp", DOCUMENT_DIR + "/10-files"])
runProcess (["cp", "solutions/10-fault-handler--assertion/sources/time.h", DOCUMENT_DIR + "/10-files"])
runProcess (["cp", "solutions/10-fault-handler--assertion/sources/dev-board-io.cpp", DOCUMENT_DIR + "/10-files"])
runProcess (["cp", "solutions/10-fault-handler--assertion/sources/dev-board-io.h", DOCUMENT_DIR + "/10-files"])
runProcess (["cp", "solutions/10-fault-handler--assertion/sources/lcd.cpp", DOCUMENT_DIR + "/10-files"])
runProcess (["cp", "solutions/10-fault-handler--assertion/sources/lcd.h", DOCUMENT_DIR + "/10-files"])
