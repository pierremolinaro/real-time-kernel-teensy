...
static CANReceivePort IN_CAN0_RECEIVE_PORT_SECTION gPort0 (0x123, kStandard, 10) ;

static CANReceivePort IN_CAN1_RECEIVE_PORT_SECTION gPort1 (0x4321, kExtended, 10) ;
